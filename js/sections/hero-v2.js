/* ==========================================================================
   ...
   A copy of js/sections/hero.js, loaded only by hero-v2.html. Class names are
   unchanged so the markup and selectors stay identical; the two never load
   together, so there is nothing to collide.
